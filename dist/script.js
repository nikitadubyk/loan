...
/* harmony import */ var _modules_differents__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/differents */ "./src/js/modules/differents.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_differents__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init();
  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]().init();
});

/***/ }),

/***/ "./src/js/modules/checkMailInputs.js":
/*!*******************************************!*\
  !*** ./src/js/modules/checkMailInputs.js ***!
  \*******************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CheckMailInputs; });
...
/*#__PURE__*/
function () {
  function CheckMailInputs(input) {
    _classCallCheck(this, CheckMailInputs);

    this.inputs = document.querySelectorAll(input);
  }

  _createClass(CheckMailInputs, [{
    key: "check",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Differents; });
...
/*#__PURE__*/
function () {
  function Differents(oldOfficer, newOfficer, items) {
    _classCallCheck(this, Differents);
...
/* harmony import */ var _checkMailInputs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./checkMailInputs */ "./src/js/modules/checkMailInputs.js");
/* harmony import */ var _phoneMask__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./phoneMask */ "./src/js/modules/phoneMask.js");
...
function () {
  ...
  _createClass(Form, [{
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              post = _context.sent;
              _context.next = 5;
              return regeneratorRuntime.awrap(post.text());
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          _this.postData(_this.path, formData).then(function (res) {
            console.log(res);
            statusMessage.textContent = _this.message.ok;
          }).catch(function () {
            statusMessage.textContent = _this.message.fail;
          }).finally(function () {
    ...
    key: "init",
    value: function init() {
      new _phoneMask__WEBPACK_IMPORTED_MODULE_6__["default"]('input[name="phone"]').init();
      new _checkMailInputs__WEBPACK_IMPORTED_MODULE_5__["default"]('input[name="email"]').check();
      this.sendForm();
    }
  }]);
...
function () {
  ...
  _createClass(PhoneMask, [{
    key: "setCurcorPosition",
    value: function setCurcorPosition(pos, elem) {
      elem.focus();
    ...
    value: function onPlayerStateChange(state) {
      try {
        var blockedElem = this.activeBtn.closest('.module__video-item').nextElementSibling,
            svgIcon = this.activeBtn.querySelector('svg').cloneNode(true);

        if (state.data === 0) {
          if (blockedElem.querySelector('.play__circle').classList.contains('closed')) {
            blockedElem.querySelector('.play__circle').classList.remove('closed');
            blockedElem.querySelector('svg').remove();
            blockedElem.querySelector('.play__circle').appendChild(svgIcon);
            blockedElem.querySelector('.play__text').textContent = 'Play Video';
            blockedElem.querySelector('.play__text').classList.remove('attention');
            blockedElem.style.opacity = 1;
            blockedElem.style.filter = 'none';
            blockedElem.setAttribute('data-disable', 'false');
          }
        }
      } catch (error) {}
    }
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.modulePrevBtn.forEach(function (arrow) {
      ...
      this.moduleNextBtn.forEach(function (arrow) {
        arrow.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function activeAnimation() {
      ...
      this.prev.parentNode.addEventListener('mouseenter', function () {
        clearInterval(play);
      });
    }
  }, {
    ...
    value: function init() {
      ...
      try {
        ...
        if (this.autoplay) {
          ...
          this.slides[0].parentNode.addEventListener('mouseover', function () {
            _this4.activeAnimation();
          });
          this.next.parentNode.addEventListener('mouseover', function () {
            _this4.activeAnimation();
          });
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$moduleNextBtn = _ref.moduleNextBtn,
      moduleNextBtn = _ref$moduleNextBtn === void 0 ? null : _ref$moduleNextBtn,
      _ref$modulePrevBtn = _ref.modulePrevBtn,
      modulePrevBtn = _ref$modulePrevBtn === void 0 ? null : _ref$modulePrevBtn,
